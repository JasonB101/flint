...
const NewItemModal = (props) => {
    const {toggleModal, submitNewItem, nextSku, items, averageShippingCost } = props;
        ...
        <div className={Styles.modalWrapper}>
            <Modal.Dialog>
                ...
                <Modal.Body>
                    ...
                    {!showItemForm && <ListingForm items={items} itemForm={newItemForm} toggleModal={toggleModal} submitNewItem={submitNewItem} averageShippingCost={averageShippingCost}/>}
                    </div>
