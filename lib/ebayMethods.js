...
async function createListing(ebayAuthToken, listingDetails) {
    ...
    const quantity = 1;
    const { title, brand, mpn, sku, listedPrice, conditionId, conditionDescription, acceptOfferHigh, declineOfferLow, description,
    ...
    <AddFixedPriceItemRequest xmlns="urn:ebay:apis:eBLBaseComponents">
      <RequesterCredentials>
        ...
        <Item>
            ...
            <Description><![CDATA[${createEbayListingTemplate(title, partNo, description, shippingService)}]]></Description>
