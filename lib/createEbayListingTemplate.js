...
function createEbayListingTemplate(title, partNo, itemSpecifics, shippingService) {
    ...
    const returnMessage = shippingService === "USPSPriority" ? 'Using the Post Office Priority Mail Return Service, shipping will be free.' : 'Contact us for instructions on returning this item.'

//     const OldHtml = `<div style="text-align: center; width: 900px; max-width: 900px; border: 3px solid #00509d; margin: 0px auto; padding: 0px; border-radius: 15px; font-size: 16px;"><div style="line-height: 50px; height: 64px; text-align: center; border-bottom: 1px solid rgb(16, 16, 16); border-top-left-radius: 12px; border-top-right-radius: 12px; background-color: #00509d; width: 900px;"><span style="font-size: 18px; font-weight: bold; color: #ffffff; text-shadow: #000000 1px 1px 2px;">${title}</span></div>
...
<p style="text-align: center;"><span style="font-family:Trebuchet MS,Helvetica,sans-serif;"><span style="font-size:48px;">JJ Auto Parts Supply</span></span></p>
...
<h2 style="color: #283055; text-align: center; line-height: 45px"><font face="Arial">Product</font></h2>
...
<p><font face="Arial"><strong>Our shipping is fast and free!</strong> This item is marked to be shipped with ${shippingService}, it will arrive at your destination in ${shippingDays} days.&nbsp;<strong>Ships within 24 business hours!</strong> Our items are packaged with common sense. You can expect your item to show up without damages. </font></p>
</div>

<div class="col-12 col-md-4" style="padding-bottom: 20px"><font face="Arial"><img alt="Contact" class="mx-auto d-block img-fluid" src="https://i.postimg.cc/dtF19kw7/alert-square-svgrepo-com.png" style="width: 20%" title="Contact" /></font>
...
<p>P/N:&nbsp;<span style="font-size:18px;"><span style="font-family:Verdana,Geneva,sans-serif;">${partNo}</span></span></p>

<p>${itemSpecs}</p>

<p>&nbsp;</p>

<p>Please examine pictures carefully to ensure you will be satisfied with the condition of the item, any scratches dents or blemishes will be made visible in the photos.</p>
