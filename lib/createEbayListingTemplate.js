function createEbayListingTemplate(title, partNo, itemSpecifics) {
    ...
    itemSpecsArray.forEach(x => x = `<p style="text-align: center;">${x}</p>`);
...
<div style="text-align: left; width: 880px; height: 153px; font-size: 16px;"><img src="http://www.pngall.com/wp-content/uploads/5/Cardboard-Box.png" style="height: 150px; vertical-align: middle; float: left; margin: 30px;"><br style="font-weight: bold;">
<ul style="">
